    ...
    <Card className='mb-4 border-0 shadow-sm'>
      <Card.Body>
        ...
        <Row className='g-3'>
          ...
          <Col md={6}>
            <Form.Group>
              <Form.Label>Rencana Disposal</Form.Label>
              <Form.Control
                type='date'
                name='disposal_plan_date'
                value={formatDateForInput(newAsset.disposal_plan_date)}
                onChange={onInputChange}
              />
              <Form.Text className='text-muted small'>Tanggal rencana disposal</Form.Text>
            </Form.Group>
          </Col>
          <Col md={6}>
            <Form.Group>
          ...
          <Col md={6}>
            <Form.Group>
              <Form.Label>Nilai Cost (At Cost)</Form.Label>
              <Form.Control
                type='text'
                name='at_cost_value'
                value={newAsset.at_cost_value ? formatRupiah(newAsset.at_cost_value) : ''}
                onChange={onInputChange}
                placeholder='Rp 0'
              />
              <Form.Text className='text-muted small'>Nilai aktual/cost</Form.Text>
            </Form.Group>
          </Col>
          <Col md={6}>
            <Form.Group>
              <Form.Label>Depresiasi Awal</Form.Label>
              <Form.Control
                type='text'
                name='initial_depreciation'
                value={
                  newAsset.initial_depreciation ? formatRupiah(newAsset.initial_depreciation) : ''
                }
                onChange={onInputChange}
                placeholder='Rp 0'
              />
              <Form.Text className='text-muted small'>Nilai depresiasi awal</Form.Text>
            </Form.Group>
          </Col>
          <Col md={6}>
            <Form.Group className='d-flex align-items-center h-100'>
              <Form.Check
                type='checkbox'
                name='is_disposed'
                checked={newAsset.is_disposed || false}
                onChange={(e) =>
                  onInputChange({ target: { name: 'is_disposed', value: e.target.checked } })
                }
                label='Sudah Disposal'
              />
            </Form.Group>
          </Col>
          <Col md={12}>
