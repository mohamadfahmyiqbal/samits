...
const OptimizedSelect = ({
  ...
  error,
  isLoading,
  controlId, // destructured to exclude from props spread
  ...props
}) => (
      ...
      <Card className='mb-4 border-0 shadow-sm'>
        <Card.Body>
          ...
          <Row className='g-3'>
            ...
            <Col md={6}>
              <Form.Group>
                <Form.Label>Kode Line/Lokasi</Form.Label>
                <Form.Control
                  type='text'
                  name='line_code'
                  value={newAsset.line_code || ''}
                  onChange={onInputChange}
                  placeholder='Contoh: LINE-A1'
                />
                <Form.Text className='text-muted small'>Kode lokasi fisik asset</Form.Text>
              </Form.Group>
            </Col>
            <Col md={6}>
              <OptimizedSelect
                label='Main Type*'
                controlId='asset_main_type_id'
