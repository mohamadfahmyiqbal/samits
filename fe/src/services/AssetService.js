...
const apiFetch = async (url, options = {}) => {
  ...
  if (!isFormDataBody && !Object.prototype.hasOwnProperty.call(headers, "Content-Type")) {
  ...
  const config = {
    ...options,
    headers,
    // ✅ TAMBAHAN KRITIS: Memaksa browser menyertakan cookie otentikasi
    credentials: 'include', 
  };
...
export const fetchAssets = async (groupOrOptions) => {
  ...
  if (typeof groupOrOptions === "string") {
    ...
    if (resolvedMainTypeId !== undefined && resolvedMainTypeId !== null && resolvedMainTypeId !== "") {
...
// ===================================================
export const fetchAssetGroups = async (mainTypeId = null, categoryId = null, subCategoryId = null) => {
  const params = new URLSearchParams();
  if (mainTypeId !== null && mainTypeId !== undefined && mainTypeId !== "") {
