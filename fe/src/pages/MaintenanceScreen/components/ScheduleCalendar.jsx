          ...
          {calendarDays.map((day, idx) => {
            ...
            return (
              <button
                ...
                aria-label={`Calendar day ${format(day, 'MMMM d, yyyy')}${isSelected ? ' (selected)' : ''}`}
      ...
      <Card.Footer className='bg-white border-top py-3 rounded-bottom'>
        <div className='d-flex justify-content-between align-items-center flex-wrap gap-2'>
          <Button
            ...
            size='sm'
            onClick={onToday}
            className='px-3 shadow-sm d-flex align-items-center gap-2'
          >
          ...
          <div className='d-flex gap-2 flex-wrap'>
            {['Hardware', 'Software', 'Infrastruktur', 'Cyber'].map((cat) => (
              <div
                key={cat}
                className='d-flex align-items-center gap-1 x-small fw-medium bg-light px-2 py-1 rounded border'
              >
                <span
                  ...
                  style={{
                    width: '8px',
                    height: '8px',
                    backgroundColor: getCategoryTextColor(cat),
                  }}
                ></span>
                {cat}
              </div>
