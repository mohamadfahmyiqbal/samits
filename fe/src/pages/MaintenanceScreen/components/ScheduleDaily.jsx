...
import { format, startOfDay, endOfDay, eachHourOfInterval, isSameHour, isToday } from 'date-fns';
      ...
      >
        {dayLogs.length === 0 ? (
          ...
          <div className='timeline-container position-relative ps-4'>
            ...
            <div
              className='position-absolute h-100 border-start border-2 opacity-20 start-0 ms-2'
              style={{ top: 0 }}
            ></div>
              ...
              return (
                ...
                >
                  ...
                  <div className='d-flex align-items-start'>
                    <div
                      className={`time-label me-3 fw-bold ${isCurrentHour ? 'text-primary' : 'text-muted'}`}
                      style={{ minWidth: '55px', fontSize: '0.85rem' }}
                    >
                      ...
                      {hourLogs.length === 0 ? (
                        ...
                        <div className='d-flex flex-column gap-2'>
                          {hourLogs.map((log, idx) => (
                            ...
                            >
                              <Card.Body
                                className='p-3 border-start border-4 rounded-end'
                                style={{
                                ...
                                <div className='d-flex justify-content-between align-items-start mb-2'>
                                  <div>
                                    <div className='d-flex align-items-center gap-2 mb-1'>
                                      ...
                                      <Badge
                                        bg={getCategoryBadgeColor(log.category)}
                                        className='x-small'
                                      >
                                        {log.category}
                                      </Badge>
                                      <Badge
                                        bg={getStatusBadgeVariant(log.status)}
                                        className='x-small'
                                      >
