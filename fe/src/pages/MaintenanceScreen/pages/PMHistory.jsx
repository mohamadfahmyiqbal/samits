...
import { Row, Col, Button, Table, Card, Alert, Spinner, Form, Badge } from 'react-bootstrap';
    ...
    <div className='p-4'>
      ...
      <Row className='mb-4 g-3'>
        ...
        <Col md={3}>
          <Card className='shadow-sm h-100'>
            <Card.Body className='text-center'>
              <div className='fs-2 fw-bold text-info mb-1'>{summary.status?.completed || 0}</div>
        ...
        <Col md={3}>
          <Card className='shadow-sm h-100'>
            <Card.Body className='text-center'>
              <div className='fs-2 fw-bold text-warning mb-1'>{summary.status?.overdue || 0}</div>
