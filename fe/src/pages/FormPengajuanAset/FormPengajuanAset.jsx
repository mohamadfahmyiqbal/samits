      ...
      case 1:
        return (
          <div className='step-content'>
            <Row gutter={[16, 16]}>
              <Col span={12}>
                <Form.Item name='preferred_vendor_id' label='Vendor Pilihan (Opsional)'>
              ...
              <Col span={12}>
                <Form.Item name='budget_estimate' label='Estimasi Anggaran'>
              ...
              <Col span={24}>
                ...
                >
                  <TextArea
                    rows={4}
                    placeholder='Contoh: Processor Intel i7, RAM 16GB, SSD 512GB, etc...'
                  />
                </Form.Item>
              </Col>
              <Col span={24}>
                <Form.Item name='preferred_brand' label='Merek Pilihan (Opsional)'>
        ...
        return (
          <div className='step-content'>
            <Row gutter={[16, 16]}>
              ...
              <Col span={24}>
                <Form.Item name='alternative_solution' label='Solusi Alternatif (Opsional)'>
          ...
          <div className='step-content'>
            ...
            <Card title='Ringkasan Pengajuan' size='small'>
              <Row gutter={[16, 16]}>
                <Col span={12}>
                  <p>
                    <strong>Tipe Pengajuan:</strong> {formData.request_type}
                  </p>
                  <p>
                    <strong>Prioritas:</strong> {formData.priority}
                  </p>
                  <p>
                ...
                <Col span={12}>
                  ...
                  <p>
                    ...
                    {vendors.find((v) => v.id === formData.preferred_vendor_id)?.name ||
                      'Tidak ada'}
                  </p>
                  <p>
                    <strong>Estimasi Anggaran:</strong> {formData.budget_estimate}
                  </p>
                  <p>
                    <strong>Tanggal Dibutuhkan:</strong> {formData.delivery_date}
                  </p>
                </Col>
              </Row>
              <Row gutter={[16, 16]}>
        ...
        <div className='preview-content'>
          ...
          <Row gutter={[16, 16]}>
            ...
            <Col span={12}>
              ...
              <p>
                <strong>Vendor:</strong>{' '}
                {vendors.find((v) => v.id === formData.preferred_vendor_id)?.name || 'Tidak ada'}
              </p>
              <p>
                <strong>Estimasi Anggaran:</strong> {formData.budget_estimate}
              </p>
