  ...
  try {
    ...
    if (typeof dateString === 'string') {
      if (dateString.length === 4) {
        ...
        // Assume YYYY-MM-DD or other parsable format
...
const AssetFormModal = ({ show, onHide, asset = null, onSave }) => {
  ...
  const effectiveAssetGroupOptions =
    assetGroupOptions.length > 0 ? assetGroupOptions : defaultAssetGroupOptions;
  ...
  const handleSave = useCallback(async () => {
    console.log(
      '🔄 DEBUG FORM SAVE - Mode:',
      isEdit ? 'EDIT' : 'ADD',
      'Payload keys:',
      Object.keys(newAsset)
    );
    ...
    try {
      ...
      console.log('📤 SENDING PAYLOAD to onSave:', {
        noAsset: payload.noAsset,
        nama: payload.nama,
      });
              ...
              <Row className='g-3'>
                ...
                <Col md={6}>
                  <OptimizedSelect
                    ...
                    placeholder={
                      !mainTypeOptions.length ? 'Memuat Main Type...' : 'Pilih Main Type'
                    }
                    required
                    error={errors.asset_main_type_id}
                  />
                  <Form.Text className='small text-info'>
                    🔍 DEBUG Main Type: ID="{newAsset.asset_main_type_id}" | Options=
                    {mainTypeOptions.length} | Selected=
                    {getSelectValue(mainTypeOptions, newAsset.asset_main_type_id)?.label || 'NONE'}
                  </Form.Text>
                </Col>
                <Col md={6}>
                  <OptimizedSelect
                    ...
                    placeholder={
                      !newAsset.asset_main_type_id ? 'Pilih Main Type dulu' : 'Pilih Kategori'
                    }
                ...
                <Col md={6}>
                  <OptimizedSelect
                    ...
                    placeholder={
                      !newAsset.category_id ? 'Pilih Kategori dulu' : 'Pilih Sub Kategori'
                    }
                ...
                <Col md={6}>
                  <OptimizedSelect
                    ...
                    placeholder={
                      !newAsset.sub_category_id ? 'Pilih Sub Kategori dulu' : 'Pilih Asset Group'
                    }
                ...
                <Col md={6}>
                  <Form.Group>
                    ...
                    <Form.Control
                      ...
                      value={
                        newAsset.purchase_price_actual
                          ? formatRupiah(newAsset.purchase_price_actual)
                          : ''
                      }
                      onChange={onInputChange}
                      placeholder='Rp 0'
              ...
              <Row className='g-3'>
                ...
                <Col md={6}>
                  <Form.Group>
                    ...
                    />
                    <Form.Text className='text-muted small'>Auto-same dengan No. Asset</Form.Text>
                  </Form.Group>
                </Col>
                <Col md={6}>
                  <Form.Group>
                    ...
                    <Form.Select
                      ...
                      value={newAsset.acquisition_status || 'Planned'}
                      onChange={onInputChange}
                    >
