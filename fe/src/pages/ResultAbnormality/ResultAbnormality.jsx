...
export default function ResultAbnormality() {
    ...
    try {
      const finalResult = {
        ...
        completion_percentage:
          resultData.work_status === 'completed' ? 100 : resultData.completion_percentage,
      };
  ...
  const currentStep =
    resultData.work_status === 'completed' ? 3 : resultData.work_status === 'in_progress' ? 2 : 1;
          ...
          <Card title='Work Result Documentation'>
            ...
            <Form form={form} layout='vertical' onFinish={handleSubmit}>
              <Card size='small' title='Job Request Information' style={{ marginBottom: 16 }}>
                <Row gutter={[16, 16]}>
                  <Col span={8}>
                    <Form.Item name='job_request_code' label='Request Code'>
                      <Input disabled />
                    </Form.Item>
                  </Col>
                  <Col span={8}>
                ...
                <Row gutter={[16, 16]}>
                  <Col span={12}>
                    <Form.Item name='asset_affected' label='Asset Affected'>
                      <Input disabled />
                    </Form.Item>
                  </Col>
                  <Col span={12}>
              ...
              >
                <TextArea
                  ...
                  onChange={(e) =>
                    setResultData((prev) => ({ ...prev, work_description: e.target.value }))
                  }
                />
              </Form.Item>
              ...
              >
                <TextArea
                  ...
                  onChange={(e) =>
                    setResultData((prev) => ({ ...prev, recommendations: e.target.value }))
                  }
                />
              </Form.Item>
                  ...
                  >
                    <DatePicker
                      ...
                      onChange={(date, dateString) =>
                        setResultData((prev) => ({ ...prev, start_time: dateString }))
                      }
                    />
                  </Form.Item>
                </Col>
                <Col span={8}>
                  ...
                  >
                    <DatePicker
                      ...
                      style={{ width: '100%' }}
                      onChange={(date, dateString) =>
                        setResultData((prev) => ({ ...prev, end_time: dateString }))
                      }
                    />
                  </Form.Item>
                </Col>
              ...
              <Form.Item label='Completion Progress'>
                <Progress
                ...
                <Row gutter={[16, 16]} style={{ marginBottom: 16 }}>
                  <Col span={6}>
                    <Input
                      ...
                      onChange={(e) =>
                        setCurrentPart((prev) => ({ ...prev, part_name: e.target.value }))
                      }
                    />
                  </Col>
                  <Col span={4}>
                  ...
                  <Col span={4}>
                    <Input value={currentPart.total_price} placeholder='Total' disabled />
                  </Col>
                  <Col span={4}>
                  ...
                  <div className='parts-list'>
                    {partsList.map((part) => (
                      <div key={part.id} className='part-item'>
                        ...
                        <Button type='link' danger onClick={() => removePart(part.id)}>
                          Remove
                        </Button>
                      </div>
                    ))}
              ...
              <Form.Item name='next_maintenance_date' label='Next Maintenance Date'>
                <DatePicker
                  style={{ width: '100%' }}
                  onChange={(date, dateString) =>
                    setResultData((prev) => ({ ...prev, next_maintenance_date: dateString }))
                  }
                />
              </Form.Item>
              ...
              <Form.Item name='attachments' label='Attachments'>
                ...
                >
                  <Button icon={<UploadOutlined />}>Upload Photos & Documents</Button>
                </Upload>
              </Form.Item>
          ...
          <Card title='Quick Tips'>
            <div className='tips-content'>
              ...
              <div className='tip-item'>
                <div className='tip-icon'>🔧</div>
                <div className='tip-text'>
                  <strong>Track Parts Used</strong> - Record all parts and materials used for the
                  job
                </div>
              </div>
              <div className='tip-item'>
                <div className='tip-icon'>📅</div>
                <div className='tip-text'>
                  <strong>Schedule Next Maintenance</strong> - Set date for follow-up maintenance if
                  needed
                </div>
              </div>
            </div>
