...
export default function Infrastructure() {
  ...
  // Ambil semua logs kategori Infrastructure
  const infraLogs = useMemo(() => logs.filter((l) => l.category === 'Infrastructure'), [logs]);
  ...
  return (
    <div className='p-3'>
      <h2 className='mb-3'>Infrastructure - Schedule Maintenance</h2>
