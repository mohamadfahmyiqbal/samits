...
import AssetHardware from './pages/AssetHardware/AssetHardware';
import AssetSoftware from './pages/AssetSoftware/AssetSoftware';
import Summary from './pages/Summarry'; // typo fixed
import AssetManagement from './pages/AssetManagement/AssetManagementPage';
import SecurityCyber from './pages/SecurityCyber/SecurityCyber';
          ...
          <Router>
            <Routes>
              ...
              >
                ...
                <Route path={`/${encryptPath('dashboard')}`} element={<RoleBasedDashboard />} />
                <Route path={`/${encryptPath('hardware')}`} element={<AssetHardware />} />
                <Route path={`/${encryptPath('software')}`} element={<AssetSoftware />} />
                <Route path={`/${encryptPath('schedule')}`} element={<Schedule />} />
                <Route path={`/${encryptPath('cyber')}`} element={<SecurityCyber />} />
                <Route path={`/${encryptPath('infrastruktur')}`} element={<Infrastructure />} />
